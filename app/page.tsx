export default function HomePage() {
  return (
    <div className="mx-auto max-w-6xl px-4 pb-16 pt-12 space-y-16 md:px-6 md:pb-24 md:pt-16">
      {/* Hero */}
      <section className="space-y-6 md:space-y-7">
        ...
        <h1 className="max-w-3xl text-3xl font-semibold tracking-tight text-slate-50 sm:text-4xl md:text-[2.75rem] md:leading-tight">
        ...
        <div className="mt-6 rounded-xl border border-slate-800 bg-slate-900/70 px-4 py-4 text-sm text-slate-200 md:px-5 md:py-5">
          <p className="mb-2 text-[11px] font-semibold tracking-[0.25em] text-slate-400 uppercase">
            For hiring managers
          </p>
          <p className="text-sm leading-relaxed text-slate-200 md:text-[0.94rem]">
      ...
      {/* Snapshot row */}
      <section className="grid gap-8 border-t border-slate-800 pt-10 md:grid-cols-3">
        <div className="space-y-3">
          <h2 className="text-[11px] font-semibold tracking-[0.25em] text-slate-400 uppercase">
            Snapshot
          </h2>
          <ul className="space-y-1.5 text-sm leading-relaxed text-slate-300 md:text-[0.94rem]">
      ...
      <section className="space-y-4 border-t border-slate-800 pt-10">
        ...
        <div className="rounded-2xl border border-slate-800/70 bg-slate-900/50 p-4 md:p-5">
          <div className="grid gap-4 md:grid-cols-3">
            <article className="group rounded-xl border border-slate-800/70 bg-slate-900/70 p-4 transition hover:border-sky-500/70 hover:bg-slate-900">
              ...
              <p className="mt-3 text-[11px] font-medium text-sky-400 group-hover:text-sky-300">
                View case study →
              </p>
            </article>
            ...
            <article className="group rounded-xl border border-slate-800/70 bg-slate-900/70 p-4 transition hover:border-sky-500/70 hover:bg-slate-900">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-300">
                Deterministic framework for real-time LLM risk triage:
                hallucination detection, bias flags, and latency anomalies.
              </p>
              <p className="mt-3 text-[11px] font-medium text-sky-400 group-hover:text-sky-300">
                View case study →
              </p>
